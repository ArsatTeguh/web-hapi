...
const NotFoundError = require('../../Excption/notFoundError');
const AuthenticationError = require('../../Excption/authenticationsError');
...
class UserService {
  ...
  async verifyUserCredential(username, password) {
    ...
    // query mencari data dari databases
    const query = {
